...
''' Добавлено изменение движения мяча в случае разной скорости удара ракетки'''
...
while 1:
    ...
    if ball.hit_bottom==True:
        time.sleep(1)
        canvas.itemconfig(game_over, state='normal') #Если функция класса мяч истина, то текст становится видимым.#
